...
서로 의견이 달라 최대한 타협점을 찾으면서 구현하려 했지만, 생각보다 쉽지 않았다. 힘들게 구현을 하고 리뷰어로부터 코드리뷰를 받았다. 리뷰어의 의견까지 반영하니 오랜 시간이 걸렸다. 그제야 깨달았다. 함께 코딩한다는 게 정말 쉽지 않구나. 소통을 위해서 내가 할 수 있는 노력이 무엇이 있나 고민했고 하나의 생각이 스쳤다. **나부터 말을 명확하고 쉽게 전달하자.** 예전에 봤던 소통과 관련된 블로그의 글이 떠올라 적어본다.
