...
그 구조가 굉장한 구조가 아니지만, 코드를 작성할 때의 접근법 자체가 달라진 것을 보고 스스로 많이 놀랐다.
...
하지만 우아한테크코스 과정을 시작하고 나서는 블로그에 그날 찾아본 내용을 짧게나마 기록하게 되었다.
블로그에 쓰는 글들은 최대한 간단하게 작성하려고 해도 남들에게 보여주는 글이라고 생각하게 되니 자세히 찾아보게 되고 깊이 공부하게 되었다.
그래서인지 포스팅을 완료하고 나서는 완전히 내 지식이 되어있었다.
다만 이렇게 짧게 기록하는 방식도 공부하는 내용이 많아지면서 '나중에 작성해야지'라고 생각만 하는 경우가 생겼다.
...
그렇기 때문에 필요할 때 찾아보고 금방 잊어도 '나중에 필요하면 다시 검색해야지'라고 생각했었고, 이런 학습 방식이 혼자 공부할 때는 큰 불편함이 없었다.
하지만 페어 프로그래밍을 진행하면서 한 줄의 코드를 작성하더라도 상대에게 설명하고 설득시켜야 했다.
이 과정에서 어중간하게 알고 있는 지식은 상대를 설득할 수 없었고, 다시 찾아봐야 했다.
하나를 공부하더라도 누구에게 설명할 수 있는 수준까지 꼼꼼하고 자세하게 공부해야 했다.
