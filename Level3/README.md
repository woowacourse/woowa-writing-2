...
#### 아쉬웠던 점
 ...
 리액트를 8주 동안 다 같이 개발에 들어가기로 했었는데, 공부를 미루고 싶은 마음에 자꾸 미루었다. 7주차가 되었을 때는 React 공부를 하기엔 이슈들이 꽤 남아있었다. 팀의 관점에서 스스로를 백엔드에 투입하는 것이 효율이 높을 것 같아 상의 후 일단 백엔드 이슈를 맡았다. 곰곰이 생각해보면 쉬는 시간을 투입하면 충분히 공부할 수 있지 않았을까 싶다. 조금 덜 나태했다면 좋았을 텐데, 아직도 선뜻 공부하려는 마음이 들지 않는다. 3레벨이 끝나고 방학 때 공부하기로 마음먹었다.
