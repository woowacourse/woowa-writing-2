...
#### 첫 팀 프로젝트에 임했던 마음가짐
 ...
 열정적인 팀과 함께 발전하면 좋겠지만, 기술적으로 뒤처져 발목을 잡진 않을지 걱정했다. 전부 다 잘할 수는 없다는 생각에 한 분야를 깊게 공부하고, 다른 부분은 필요할 만큼만 공부하자고 마음먹었다. 각자 한 분야를 깊게 공부하면, 모두가 얕게 알 때보다 서로 도우며 이슈를 빠르게 해결할 것이라 믿었다. 그뿐만 아니라, 도움을 주고받으며 빠르게 성장할 수 있을 것 같았다.
